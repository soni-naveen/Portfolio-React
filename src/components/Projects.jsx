  ...
  return (
    <div id="projects" className="pt-10">
      <div className="w-[80%] mx-auto">
        ...
        <div className="py-10 sm:py-16 max-w-6xl mx-auto w-fit space-y-14">
          <SpotlightCard
              ...
              <div className="flex flex-col gap-7 xl:gap-0 justify-between py-2 max-w-lg lg:max-w-xl">
                <div className="font-light">
                  <a href="https://theecoride.in" target="_blank">
                    <h1 className="text-xl xs:text-2xl sm:text-3xl mb-3 flex items-center gap-2 sm:gap-3 hover:underline">
                      EcoRide
              ...
              <div className="flex flex-col gap-7 xl:gap-0 justify-between py-2 max-w-lg lg:max-w-xl">
                <div className="font-light">
                  <a href="https://e-social.vercel.app" target="_blank">
                    <h1 className="text-xl xs:text-2xl sm:text-3xl mb-3 flex items-center gap-2 sm:gap-3 hover:underline tracking-wide">
                      E-Social
                      <FiExternalLink className="text-lg xs:text-xl sm:text-2xl text-cyan-400 cursor-pointer" />
                    </h1>
                  </a>
                  <p className="text-xs xs:text-sm sm:text-base">
                    ...
                    creation, deletion, commenting, likes, and a friend request
                    system. Designed scalable RESTful APIs with Express.js and
                    MongoDB for efficient user interactions and smooth
                    performance.
                  </p>
                </div>
                <div className="flex gap-2 xs:gap-3">
              ...
              <div className="flex flex-col gap-7 xl:gap-0 justify-between py-2 max-w-lg lg:max-w-xl">
                <div className="font-light">
                  ...
                  <p className="text-xs xs:text-sm sm:text-base">
                    ...
                    scratch, incorporating smooth animations and a modern design
                    to enhance user experience. Implemented a Google
                    Sheet-integrated contact form for seamless data collection
                    and management. This project was completed as part of an
                    internship, demonstrating skills in frontend development and
                    responsiveness.
                  </p>
                </div>
                <div className="flex gap-2 xs:gap-3">
            ...
            <div className="text-white font-poppins flex flex-col xl:flex-row gap-4 sm:gap-8 xl:gap-16 cursor-default">
              ...
              <div className="flex flex-col gap-7 xl:gap-0 justify-between py-2 max-w-lg lg:max-w-xl">
                <div className="font-light">
                  ...
                  <p className="text-xs xs:text-sm sm:text-base">
                    A real-time two-player game built using WebSockets, ensuring
                    smooth and interactive gameplay with minimal latency.
                    Designed with a fully responsive interface for an optimal
                    experience across all devices. Implemented a room-based
                    matchmaking system, allowing players to seamlessly create
                    and join game sessions, enhancing accessibility and user
                    engagement.
                  </p>
                </div>
                <div className="flex gap-2 xs:gap-3">
          ...
          <p className="text-white font-poppins text-xl text-center font-light underline">
            <a href="https://github.com/soni-naveen?tab=repositories" target="_blank">
              view more...
            </a>
          </p>
        </div>
